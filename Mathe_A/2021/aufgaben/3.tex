...
\begin{align*}
	...
	\leq C \frac{1}{n} \to 0
\end{align*}
für $n \to \infty$. Für (c) - (e) ist schnell ersichtlich, dass der Nenner schneller als der Zähler wächst. Kniffliger ist (b), jedoch nur auf den ersten Blick:
\begin{align*}
	b_n = \sqrt{n^2 +1} - n
...
Übrig bleibt noch (f). Bei Folgen dieser Art ist es nur notwendig die führenden Potenzen im Zähler und Nenner zu vergleichen:
\begin{align*}
...
\begin{align*}
	...
	=
	\frac{n^3 \left(1 + \frac{5}{n} + \frac{5}{n^2}  - \frac{2}{n^3}\right)}{n^3 \left( 5 + \frac{4}{n^3} \right)}\\
	&=
	\frac{1 + \frac{5}{n} + \frac{5}{n^2}  - \frac{2}{n^3}}{
		 5 + \frac{4}{n^3}}
...
\begin{align*}
	f_x(x,y)
	&=
	\frac{1}{2} \cdot \cos(x^2 + y^2) \cdot 2 \cdot x
	=
	x \cdot \cos(x^2 + y^2)\\
	f_y(x,y)
	&=
	\frac{1}{2} \cdot \cos(x^2 + y^2)
	=
	y \cdot \cos(x^2 + y^2) \cdot 2 \cdot y
	.
\end{align*}
...
In den Argumenten der Exponential bzw. Logarithmusfunktion muss sich das $\lambda$ herauskürzen. Sonst kann die Funktion nicht homogen sein. Wenn man dies überprüft hat, kann man diese Funktionen ignorieren.
Als nächstes prüft man, ob sich $\lambda $ in jedem Summanden mit demselben Exponent ausklammern lässt.
