...
\renewcommand{\labelenumi}{\theenumi.}
\begin{enumerate}
\item Vergleiche das Projekt mit einem Zahlungsstrom, welches die Ausgangseinzahlung auszahlt.
\end{enumerate}
\end{mdframed}

\underline{1. Vergleiche das Projekt mit einem Zahlungsstrom, welches die Ausgangseinzahlung auszahlt}\\
...
\\
Sei nun $x_0 $ der einzige lokale Extrempunkt auf $(a,b)$. Zur Vereinfachung nehmen wir an, dass dies ein Maximum ist. Dann gilt 
\begin{align*}
	f(x) \geq  0
\end{align*}
für alle $x \in [a, x_0)$ und 
\begin{align*}
	f(x) \leq 0
\end{align*}
für alle $ x \in (x_0, b]$ gelten. Zu beachten ist, dass die Gleichheit nur an den Randpunkten $a$ und $b$ auftreten kann. Also ist die $f$ auf $(a, x_0)$ streng monoton wachsend (Auf $[a,x_0) ]$ monoton wachsend) und auf $(x_0,b)$ streng monoton fallend.
Falls der Extrempunkt ein Minimum ist, tauschen sich wachsend und fallend die Reihenfolge.\\
\\
Damit ist die Antwort (c) korrekt.
